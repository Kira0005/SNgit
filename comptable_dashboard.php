<?php
session_start();
// Vérifie si l'utilisateur est connecté et a le rôle 'comptable'
...
<head>
    ...
    <title>ChicRush - Tableau de Bord Comptable</title>
...
<body class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="container text-center">
        <h1 class="mb-4 text-success">Bienvenue, Comptable !</h1>
        <p class="lead">Ceci est votre tableau de bord. Vous pouvez gérer les factures, les rapports financiers, etc.</p>
